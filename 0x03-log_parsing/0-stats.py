...
# storage count of all status codes in a dictionary
status_codes_dict = {'200': 0, '301': 0, '400': 0, '401': 0, '403': 0,
                     '404': 0, '405': 0, '500': 0}

total_size = 0
count = 0  # keeps count of number of lines counted
...
try:
    for line in sys.stdin:
        ...
        if len(line_list) > 4:
            ...
            # checks if the status code received exists in the dictionary and
            # increments count
